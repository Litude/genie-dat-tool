...
export const CombatantObjectPrototypeSchema = ActorObjectPrototypeSchema.merge(z.object({
...
type CombatantObjectPrototypeJson = z.infer<typeof CombatantObjectPrototypeSchema>;

const CombatantObjectPrototypeJsonMapping: JsonFieldMapping<CombatantObjectPrototype, CombatantObjectPrototypeJson>[] = [
    { field: "baseArmor" },
    { field: "attackTypes" },
    { field: "armorTypes" },
    { jsonField: "bonusHabitatId", toJson: (obj) => createReferenceString("Habitat", obj.bonusHabitat?.referenceId, obj.bonusHabitatId) },
    { objectField: "bonusHabitatId", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<HabitatId>("Habitat", obj.referenceId, json.habitatId, loadingContext.dataIds.habitatIds) },
    { field: "maxRange" },
    { field: "blastRadius" },
    { field: "attackSpeed" },
    { jsonField: "projectileUnitId", toJson: (obj) => createReferenceString("ObjectPrototype", obj.projectileUnit?.referenceId, obj.projectileUnitId) },
    { objectField: "projectileUnitId", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<PrototypeId<Int16>>("ObjectPrototype", obj.referenceId, json.projectileUnitId, loadingContext.dataIds.prototypeIds) },
    { field: "accuracy" },
    ...
    { field: "minRange" },
    { jsonField: "attackSpriteId", toJson: (obj) => createReferenceString("Sprite", obj.attackSprite?.referenceId, obj.attackSpriteId ) },
    { objectField: "attackSpriteId", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<SpriteId>("Sprite", obj.referenceId, json.attackSpriteId, loadingContext.dataIds.spriteIds) },
...
export class CombatantObjectPrototype extends ActorObjectPrototype {
    ...
    toJson(savingContext: SavingContext) {
        return {
            ...
            ...transformObjectToJson(this, CombatantObjectPrototypeJsonMapping, savingContext)
        }
    }
}
