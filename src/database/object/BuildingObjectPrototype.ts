...
import { OverlayId, PrototypeId, ReferenceStringSchema, SoundEffectId, SpriteId, TechnologyId, TerrainId } from "../Types";
import { asBool8, asInt16, asUInt8, Bool8, Bool8Schema, Int16, Int16Schema, UInt8, UInt8Schema } from "../../ts/base-types";
...
export const BuildingObjectPrototypeSchema = AdvancedCombatantObjectPrototypeSchema.merge(z.object({
...
type BuildingObjectPrototypeJson = z.infer<typeof BuildingObjectPrototypeSchema>;

const BuildingObjectPrototypeJsonMapping: JsonFieldMapping<BuildingObjectPrototype, BuildingObjectPrototypeJson>[] = [
    { jsonField: "constructionSpriteId", toJson: (obj) => createReferenceString("Sprite", obj.constructionSprite?.referenceId, obj.constructionSpriteId) },
    { objectField: "constructionSpriteId", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<SpriteId>("Sprite", obj.referenceId, json.constructionSpriteId, loadingContext.dataIds.spriteIds) },
    { field: "adjacentConnectionMode" },
    { field: "graphicsOffset" },
    { field: "removeWhenBuilt" },
    { jsonField: "createdObjectIdWhenBuilt", toJson: (obj) => createReferenceString("ObjectPrototype", obj.createdObjectWhenBuilt?.referenceId, obj.createdObjectIdWhenBuilt) },
    { objectField: "createdObjectIdWhenBuilt", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<PrototypeId<Int16>>("ObjectPrototype", obj.referenceId, json.createdObjectIdWhenBuilt, loadingContext.dataIds.prototypeIds) },
    { jsonField: "changedTerrainIdWhenBuilt", toJson: (obj) => createReferenceString("Terrain", obj.changedTerrainWhenBuilt?.referenceId, obj.changedTerrainIdWhenBuilt) },
    { objectField: "changedTerrainIdWhenBuilt", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<TerrainId<Int16>>("Terrain", obj.referenceId, json.changedTerrainIdWhenBuilt, loadingContext.dataIds.terrainIds )},
    { jsonField: "placedOverlayIdWhenBuilt", toJson: (obj) => createReferenceString("Overlay", obj.placedOverlayWhenBuilt?.referenceId, obj.placedOverlayIdWhenBuilt )},
    { objectField: "placedOverlayIdWhenBuilt", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<OverlayId<Int16>>("Overlay", obj.referenceId, json.placedOverlayIdWhenBuilt, loadingContext.dataIds.overlayIds) },
    { jsonField: "researchedTechnologyIdWhenBuilt", toJson: (obj) => createReferenceString("Technology", obj.researchedTechnologyWhenBuilt?.referenceId, obj.researchedTechnologyIdWhenBuilt) },
    { objectField: "researchedTechnologyIdWhenBuilt", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<TechnologyId<Int16>>("Technology", obj.referenceId, json.researchedTechnologyIdWhenBuilt, loadingContext.dataIds.technologyIds) },
    { jsonField: "constructionSoundEffectId", toJson: (obj) => createReferenceString("SoundEffect", obj.constructionSoundEffect?.referenceId, obj.constructionSoundEffectId) },
    { objectField: "constructionSoundEffectId", fromJson: (json, obj, loadingContext) => getIdFromReferenceString<SoundEffectId<Int16>>("SoundEffect", obj.referenceId, json.constructionSoundEffectId, loadingContext.dataIds.soundEffectIds) },
];
...
export class BuildingObjectPrototype extends AdvancedCombatantObjectPrototype {
    ...
    createdObjectIdWhenBuilt: PrototypeId<Int16> = asInt16<PrototypeId<Int16>>(-1); // this was probably meant to be combined with the above flag so a unit is created when building is finished and the building itself is removed (not removing the building causes bugs such as the unit being created again when loading a game)
    ...
    toJson(savingContext: SavingContext) {
        return {
            ...
            ...transformObjectToJson(this, BuildingObjectPrototypeJsonMapping, savingContext)
        }
    }
}
