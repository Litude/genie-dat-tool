...
export const MobileObjectPrototypeSchema = AnimatedObjectPrototypeSchema.merge(
  z.object({
...
const MobileObjectPrototypeJsonMapping: JsonFieldMapping<
  MobileObjectPrototype,
  MobileObjectPrototypeJson
>[] = [
  {
    jsonField: "walkingSpriteId",
    toJson: (obj) =>
      createReferenceString(
        "Sprite",
        obj.walkingSprite?.referenceId,
        obj.walkingSpriteId,
      ),
  },
  {
    objectField: "walkingSpriteId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<SpriteId>(
        "Sprite",
        obj.referenceId,
        json.walkingSpriteId,
        loadingContext.dataIds.spriteIds,
      ),
  },
  {
    jsonField: "runningSpriteId",
    toJson: (obj) =>
      createReferenceString(
        "Sprite",
        obj.runningSprite?.referenceId,
        obj.runningSpriteId,
      ),
  },
  {
    objectField: "runningSpriteId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<SpriteId>(
        "Sprite",
        obj.referenceId,
        json.runningSpriteId,
        loadingContext.dataIds.spriteIds,
      ),
  },
  { field: "rotationSpeed" },
  ...
  {
    jsonField: "trailingUnitPrototypeId",
    toJson: (obj) =>
      createReferenceString(
        "ObjectPrototype",
        obj.trailingUnitPrototype?.referenceId,
        obj.trailingUnitPrototypeId,
      ),
  },
  {
    objectField: "trailingUnitPrototypeId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<PrototypeId<Int16>>(
        "ObjectPrototype",
        obj.referenceId,
        json.trailingUnitPrototypeId,
...
export class MobileObjectPrototype extends AnimatedObjectPrototype {
  ...
  readFromJsonFile(
    jsonFile: MobileObjectPrototypeJson,
    ...
    applyJsonFieldsToObject(
      jsonFile,
      this,
      MobileObjectPrototypeJsonMapping,
      loadingContext,
    );
  }
  ...
  linkOtherData(
    ...
    this.walkingSprite = getDataEntry(
      sprites,
      this.walkingSpriteId,
      "Sprite",
      this.referenceId,
      loadingContext,
    );
    this.runningSprite = getDataEntry(
      sprites,
      this.runningSpriteId,
      "Sprite",
      this.referenceId,
      loadingContext,
    );
    this.trailingUnitPrototype = getDataEntry(
      objects,
      this.trailingUnitPrototypeId,
      "ObjectPrototype",
      this.referenceId,
      loadingContext,
    );
