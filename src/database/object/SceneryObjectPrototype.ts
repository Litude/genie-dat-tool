...
export const SceneryObjectPrototypeSchema = z.object({
  ...
  placementNeighbouringTerrainIds: z
    .array(ReferenceStringSchema)
    .max(2)
    .optional(),
  placementUnderlyingTerrainIds: z
    .array(ReferenceStringSchema)
    .max(2)
    .optional(),
...
export type SceneryObjectPrototypeJson = z.infer<
  typeof SceneryObjectPrototypeSchema
>;
...
function isTrackedAsResource(prototype: SceneryObjectPrototype) {
  return asBool8(
    [
      ObjectClasses.Fish,
      ObjectClasses.ForageFruit,
      ObjectClasses.StoneOrGoldMine,
      ObjectClasses.StoneMine,
      ObjectClasses.GoldMine,
      ObjectClasses.Tree,
    ].includes(prototype.objectClass),
  );
}
...
function getResourceGatherGroup(prototype: SceneryObjectPrototype) {
  switch (prototype.objectClass) {
    ...
    case ObjectClasses.StoneOrGoldMine:
      if (
        prototype.attributesStored.some(
          (attribute) => attribute.attributeId === 2,
        )
      ) {
        return 3;
      } else if (
        prototype.attributesStored.some(
          (attribute) => attribute.attributeId === 3,
        )
      ) {
        return 4;
      } else {
        Logger.warn(
          `Could not determine mine type ${prototype.id} resource group`,
        );
      }
      break;
    ...
    default:
      Logger.warn(
        `Tried to get resourceGatherGroup but ${prototype.id} is not a resource`,
      );
      break;
  }
  return 0;
...
const SceneryObjectPrototypeJsonMapping: JsonFieldMapping<
  SceneryObjectPrototype,
  SceneryObjectPrototypeJson
>[] = [
  { field: "objectType" },
  { field: "internalName" },
  { field: "nameStringId" },
  ...
  { field: "objectClass" },
  {
    jsonField: "idleSpriteId",
    toJson: (obj) =>
      createReferenceString(
        "Sprite",
        obj.idleSprite?.referenceId,
        obj.idleSpriteId,
      ),
  },
  {
    objectField: "idleSpriteId",
  ...
  {
    jsonField: "deathSpriteId",
    toJson: (obj) =>
      createReferenceString(
        "Sprite",
        obj.deathSprite?.referenceId,
        obj.deathSpriteId,
      ),
  },
  {
    objectField: "deathSpriteId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<SpriteId>(
        "Sprite",
        obj.referenceId,
  ...
  {
    jsonField: "undeadSpriteId",
    toJson: (obj) =>
      createReferenceString(
        "Sprite",
        obj.undeadSprite?.referenceId,
        obj.undeadSpriteId,
      ),
  },
  {
    objectField: "undeadSpriteId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<SpriteId>(
        "Sprite",
        obj.referenceId,
  ...
  {
    jsonField: "creationSoundId",
    toJson: (obj) =>
      createReferenceString(
        "SoundEffect",
        obj.creationSound?.referenceId,
        obj.creationSoundId,
      ),
  },
  {
    objectField: "creationSoundId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<SoundEffectId<Int16>>(
        "SoundEffect",
        obj.referenceId,
        json.creationSoundId,
        loadingContext.dataIds.soundEffectIds,
      ),
  },
  {
    jsonField: "deadUnitPrototypeId",
    toJson: (obj) =>
      createReferenceString(
        "ObjectPrototype",
        obj.deadUnitPrototype?.referenceId,
        obj.deadUnitPrototypeId,
      ),
  },
  {
    objectField: "deadUnitPrototypeId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<PrototypeId<Int16>>(
        "ObjectPrototype",
        obj.referenceId,
        json.deadUnitPrototypeId,
  ...
  },
  {
    ...
    fromJson: (json, obj, loadingContext) =>
      json.placementNeighbouringTerrainIds?.map((terrainId) =>
  ...
  },
  {
    ...
    versionFrom: "1.4.0",
    fromJson: (json, obj, loadingContext) =>
      json.placementUnderlyingTerrainIds?.map((terrainId) =>
        getIdFromReferenceString<TerrainId<Int16>>(
          "Terrain",
          obj.referenceId,
          terrainId,
  ...
  { field: "fogVisibility" },
  {
    jsonField: "habitatId",
    toJson: (obj) =>
      createReferenceString("Habitat", obj.habitat?.referenceId, obj.habitatId),
  },
  {
    objectField: "habitatId",
    fromJson: (json, obj, loadingContext) =>
  ...
  },
  {
    ...
    toJson: (obj) =>
      obj.damageSprites.map((damageSprite) => ({
        spriteId: createReferenceString(
          "Sprite",
          damageSprite.sprite?.referenceId,
          damageSprite.spriteId,
        ),
  ...
  {
    objectField: "damageSprites",
    fromJson: (json, obj, loadingContext) =>
      json.damageSprites.map((damageSprite) => ({
        spriteId: getIdFromReferenceString<SpriteId>(
          "Sprite",
          obj.referenceId,
          damageSprite.spriteId,
          loadingContext.dataIds.spriteIds,
  ...
  {
    jsonField: "selectionSoundId",
    toJson: (obj) =>
      createReferenceString(
        "SoundEffect",
        obj.selectionSound?.referenceId,
        obj.selectionSoundId,
      ),
  },
  {
    objectField: "selectionSoundId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<SoundEffectId<Int16>>(
        "SoundEffect",
        obj.referenceId,
        json.selectionSoundId,
        loadingContext.dataIds.soundEffectIds,
      ),
  },
  {
    jsonField: "deathSoundId",
    toJson: (obj) =>
      createReferenceString(
        "SoundEffect",
        obj.deathSound?.referenceId,
        obj.deathSoundId,
      ),
  },
  {
    objectField: "deathSoundId",
    fromJson: (json, obj, loadingContext) =>
      getIdFromReferenceString<SoundEffectId<Int16>>(
        "SoundEffect",
        obj.referenceId,
  ...
  {
    jsonField: "upgradeUnitPrototypeId",
    flags: { internalField: true },
    toJson: (obj) =>
      createReferenceString(
        "ObjectPrototype",
        obj.upgradeUnitPrototype?.referenceId,
        obj.upgradeUnitPrototypeId,
      ),
  },
  {
    objectField: "upgradeUnitPrototypeId",
    flags: { internalField: true },
    fromJson: (json, obj, loadingContext) =>
      json.upgradeUnitPrototypeId !== undefined
        ? getIdFromReferenceString<PrototypeId<Int16>>(
            "ObjectPrototype",
            obj.referenceId,
            json.upgradeUnitPrototypeId,
            loadingContext.dataIds.prototypeIds,
          )
        : undefined,
  },
...
export class SceneryObjectPrototype {
  ...
  readFromBuffer(
    ...
    if (this.id !== id) {
      Logger.warn(
        `Mismatch between stored Object id ${this.id} and ordering ${id}, data might be corrupt!`,
      );
    }
    ...
    if (semver.gte(loadingContext.version.numbering, "2.7.0")) {
      ...
      this.helpDialogStringId = asInt32<StringId<Int32>>(
        this.nameStringId >= 5000 && this.nameStringId < 6000
          ? this.nameStringId + 100000
          : 0,
      );
      this.helpPageStringId = asInt32<StringId<Int32>>(
        this.nameStringId >= 5000 && this.nameStringId < 6000
          ? this.nameStringId + 150000
          : 0,
      );
      this.hotkeyStringId = asInt32<StringId<Int32>>(
        this.nameStringId >= 5000 &&
          this.nameStringId < 6000 &&
          this.creationStringId > 0
          ? this.nameStringId + 11001
          : 0,
      );
    ...
    this.internalName =
      nameLength > 0 ? buffer.readFixedSizeString(nameLength) : "";
    ...
    if (semver.gte(loadingContext.version.numbering, "3.5.0")) {
      ...
      if (this.upgradeUnitPrototypeId !== this.id) {
        Logger.warn(
          `Mismatch between stored Object id ${this.id} and upgrade id ${this.upgradeUnitPrototypeId}, data might be corrupt!`,
        );
      }
    } else {
    ...
    if (semver.lt(loadingContext.version.numbering, "3.1.0")) {
      ...
      this.resourceGroup = asUInt8(
        this.trackAsResource ? getResourceGatherGroup(this) : 0,
      );
  ...
  readFromJsonFile(
    jsonFile: SceneryObjectPrototypeJson,
    ...
    applyJsonFieldsToObject(
      jsonFile,
      this,
      SceneryObjectPrototypeJsonMapping,
      loadingContext,
    );
  ...
  linkOtherData(
    ...
    _technologies: Nullable<Technology>[],
    _overlays: Nullable<Overlay>[],
    loadingContext: LoadingContext,
  ) {
    this.idleSprite = getDataEntry(
      sprites,
      this.idleSpriteId,
      "Sprite",
      this.referenceId,
    ...
    this.undeadSprite = getDataEntry(
      sprites,
      this.undeadSpriteId,
      "Sprite",
      this.referenceId,
    ...
    this.damageSprites.forEach((damageSprite) => {
      damageSprite.sprite = getDataEntry(
        sprites,
        damageSprite.spriteId,
        "Sprite",
        this.referenceId,
    ...
    this.creationSound = getDataEntry(
      soundEffects,
      this.creationSoundId,
      "SoundEffect",
      this.referenceId,
      loadingContext,
    );
    this.selectionSound = getDataEntry(
      soundEffects,
      this.selectionSoundId,
      "SoundEffect",
      this.referenceId,
      loadingContext,
    );
    this.deathSound = getDataEntry(
      soundEffects,
      this.deathSoundId,
      "SoundEffect",
      this.referenceId,
    ...
    this.deadUnitPrototype = getDataEntry(
      objects,
      this.deadUnitPrototypeId,
      "ObjectPrototype",
      this.referenceId,
      loadingContext,
    );
    this.upgradeUnitPrototype = getDataEntry(
      objects,
      this.upgradeUnitPrototypeId,
      "ObjectPrototype",
      this.referenceId,
      loadingContext,
    );

    this.habitat = getDataEntry(
      habitats,
      this.habitatId,
      "Habitat",
      this.referenceId,
    ...
    this.placementNeighbouringTerrains =
      this.placementNeighbouringTerrainIds.map((terrainId) =>
        getDataEntry(
          terrains,
          terrainId,
          "Terrain",
    ...
    this.placementUnderlyingTerrains = this.placementUnderlyingTerrainIds.map(
      (terrainId) =>
        getDataEntry(
          terrains,
          terrainId,
  ...
  appendToTextFile(
    ...
    if (
      ...
      this.objectType % 10 !== 0
    ) {
      throw new Error(
        `${this.objectType} is not supported by version ${savingContext.version}`,
      );
    }
    ...
    const outlineRadius =
      this.selectionOutlineRadius.x !== this.collisionRadius.x ||
    ...
    if (semver.gte(savingContext.version.numbering, "3.3.0")) {
      textFileWriter
        ...
        .float(
          outlineRadius
            ? this.selectionOutlineRadius.x
            : this.collisionRadius.x,
        )
        .float(
          outlineRadius
            ? this.selectionOutlineRadius.y
            : this.collisionRadius.y,
        )
        .float(
          outlineRadius
            ? this.selectionOutlineRadius.z
            : this.collisionRadius.z,
        );
    }
    ...
    textFileWriter.indent(6).integer(this.damageSprites.length).eol();
